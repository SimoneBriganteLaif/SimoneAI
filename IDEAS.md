...
|----|------|-----------|--------|----------|-------|------|------|
| IDEA-001 | Scheduled task giornaliera: git diff → auto-changelog → commit/tag se modifiche | automazione | M | alta | proposta | 2026-03-08 | Usare scheduled tasks di Claude Code. "Staccare una versione" giornaliera solo se ci sono diff |
