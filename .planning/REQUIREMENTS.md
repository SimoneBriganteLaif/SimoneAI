...
- [ ] **EDIT-01**: User can add a new table with name and tablename
- [ ] **EDIT-02**: User can rename an existing table (class name + tablename)
- [ ] **EDIT-03**: User can delete a table (with confirmation)
...
- [ ] **PERS-02**: Table positions and groups are saved in a sidecar .er.json file
- [ ] **PERS-03**: Reopening a model.py with an existing .er.json restores positions and groups
...
- [ ] **UX-03**: Auto-layout algorithm places tables when no .er.json exists
